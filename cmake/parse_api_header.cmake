...
function(parse_api_header)
    ...
    foreach(line ${content})
        ...
        string(REGEX MATCHALL "(void \\*|int32_t|uint32_t|int64_t|uint64_t|double)" arg_types "${args}")
        set(ARG_TYPES "${arg_types}")

        string(REPLACE "uint32_t " "" args_without_types "${args}")
        string(REPLACE "int32_t " "" args_without_types "${args_without_types}")
        string(REPLACE "uint64_t " "" args_without_types "${args_without_types}")
        string(REPLACE "int64_t " "" args_without_types "${args_without_types}")
        string(REPLACE "double " "" args_without_types "${args_without_types}")
